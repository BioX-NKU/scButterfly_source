...
if model_type == 'totalVI_augmentation':
    ...
    if data == "CITE_BMMC":
        id_list = bmmc_batch_split_dataset(adata_gene, adata_protein, seed=19191)
    if data == "CITE_BM":
        id_list = bm_batch_split_dataset(adata_gene, adata_protein, seed=19191)
...
if data == 'CITE_BM':
    id_list = bm_batch_split_dataset(RNA_data, ATAC_data)
train_id, validation_id, test_id = id_list[int(number) - 1]
